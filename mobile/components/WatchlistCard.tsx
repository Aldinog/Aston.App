...
export default function WatchlistCard({ symbol, description, price, change, changePercent, sparkline, magicScore, onPress }: WatchlistCardProps) {
    ...
    const chartData = sparkline.length > 0
        ? sparkline.map((val, idx) => ({ timestamp: idx, value: val }))
    ...
    return (
        ...
        >
            ...
            <View className="w-24 h-12 mr-2 justify-center">
                <LineChart.Provider data={chartData}>
                    <LineChart width={90} height={40}>
