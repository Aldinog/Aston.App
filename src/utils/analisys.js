...
// Use getPersistentCandles instead of fetchHistorical directly
...
async function analyzeStock(symbol) {
    // Replacement for getHistorical: use getPersistentCandles with limit ~80
    const candles = await getPersistentCandles(symbol, '1d', 80);
